...
export default function NewRestaurantPage() {
  ...
  const [form, setForm] = useState({
    ...
    servicePeriods: [{ nameRo: 'Lunch', nameEn: 'Lunch', startTime: '12:00', endTime: '15:00', daysOfWeek: [0, 1, 2, 3, 4, 5, 6] }],
    maxPartySize: 30,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiPost('/api/admin/restaurants', form)
    ...
    return (
      <div className="max-w-lg mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Restaurant Created!</h2>
          <p className="text-gray-600 mb-6">
            Save these credentials for {form.nameEn || form.nameRo}:
          </p>
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800">Create Restaurant</h1>
        <p className="text-gray-600 mt-1">Fill in all required information</p>
      </div>
